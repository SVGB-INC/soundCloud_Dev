  ...
  try {
    ...
    if ($select_stmt->rowCount() > 0) {
      ...
      if ($stmt->execute([$_SESSION["user_name"]])) {
       ...
       $insert_stmt->execute([$audio_id, $authorNameNew, $_SESSION["user_name"], '0', '0', $payDetails["podcast_charity"], $date]);
       //insert payment details
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-8 p-0">
          <form class="form py-5 px-md-4 px-2 px-lg-4 bg-opacity-75" name="signupform" method="post" style="min-height: 33rem;">
            <h1 class="text-center">Additional Charity</h1>
              ...
              <div class="payment-select-container">
                ...
                <div class="form-check d-flex justify-content-between">
                  ...
                  <div class="input d-flex justify-content-center align-items-center gap-2" >
                    ...
                    <input class="form-control p-1" style="width: 5rem;" type="text" value=<?php echo $payDetails["podcast_charity"]; ?> disabled name="charity-pay-ammount" id="charity-pay-ammount">
                  </div>
                </div>
              </div>
...
console.log('acc', charity_acc);
console.log('char_pay ', charity_payment);
console.log('add_pay ', additional_payment);
console.log('total_pay ', toal_payment);
paypal.Buttons({
  style:{
  color:'white',
  shape: 'pill',
