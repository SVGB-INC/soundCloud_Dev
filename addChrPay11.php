  ...
  try {
    ...
    if ($select_stmt->rowCount() > 0) {
      ...
      if ($stmt->execute([$_SESSION["user_name"]])) {
       ...
       $insert_stmt->execute([$audio_id, $authorNameNew, $_SESSION["user_name"], ($payDetails["podcast_payment"] * ($admin_details["add_share_admin"] / 100)), ($payDetails["podcast_payment"] * ($admin_details["add_share_creator"] / 100)), $payDetails["podcast_charity"], $date]);
       //insert payment details
      ...
      if ($insert_stmt->execute([$_SESSION["user_name"], $podcast_address, $podcast_address])) {
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-8 p-0">
          <form class="form py-5 px-md-4 px-2 px-lg-4 bg-opacity-75" name="signupform" method="post" style="min-height: 33rem;">
            <h1 class="text-center">Additional Payment and Additional Charity</h1>
              ...
              <div class="payment-select-container">
                ...
                <div class="form-check d-flex justify-content-between">
                  ...
                  <div class="input d-flex justify-content-center align-items-center gap-2">
                    ...
                    <input class="form-control p-1" style="width: 5rem;" type="text" value=<?php echo $payDetails["podcast_charity"]; ?> disabled name="additional-pay-charity" id="charity-pay-ammount">
                  </div>
                </div>
...
<script>
  ...
  let charity_payment = document.getElementById('charity-pay-ammount').value;
