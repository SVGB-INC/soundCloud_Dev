      ...
      <div class="row pt-5">
        ...
        <div class="col-md-8 p-0">
          <form class="form py-5 px-md-4 px-2 px-lg-4 bg-opacity-75" name="signupform" method="post" style="min-height: 33rem;">
            <h1 class="text-center">Optional Payment and Optional Charity</h1>
            <div class="container-section">
              ...
              <div class="payment-select-container">
                ...
                <div class="form-check d-flex justify-content-between">
                  ...
                  <div class="input d-flex justify-content-center align-items-center gap-2">
                    <label class="ms-auto form-check-label" for="charity-pay-ammount">
                      Amount USD
                    </label>
              ...
              <button id="without_pay" type="submit" class="btn mt-3 pink-bg text-white w-100">Submit</button>
...
<script>
  ...
  // additional payment element value
  ...
  // charity payment element value
  var charity_payment_element = document.getElementById('charity-pay-ammount');
  ...
  //  show and hide buttuns

  document.getElementById("without_pay").style.display = "none";
  if (toal_payment <= 0 || !toal_payment) {
    document.getElementById("without_pay").style.display = "block";
    document.getElementById("paypal_payment").style.display = "none";
  }

  // charity payment change
  charity_payment_element.addEventListener('keyup', function(e) {
    ...
    if (toal_payment <= 0 || toal_payment === null || toal_payment === '' || !toal_payment) {
      document.getElementById("without_pay").style.display = "block";
      document.getElementById("paypal_payment").style.display = "none";
    } else {
