              ...
              <div class="container-section">
                ...
                <div class="payment-select-container cardPaymentContainer">
                  ...
                  <div class="input my-1">
                    ...
                    <input type="text" class="form-control" name="creditCardName" placeholder="Name on Card" maxlength="16" />
                  </div>
                  <div class="input my-1">
                    <label class="text-start" for="creditCardNumber">Card Number</label>
                    <input type="number" class="form-control" name="creditCardNumber" placeholder="Card Number" maxlength="16" />
                  </div>
                  <div class="input my-1">
                    ...
                    <input class="form-control" name="creditExpirationMonth" placeholder="MM/YYYY" type="month" />
                  </div>
                  <div class="input my-1">
                    ...
                    <input class="form-control" id="creditCVV" placeholder="Security Code (CVV)" maxlength="3" type="tel" />
                  </div>
                </div>
