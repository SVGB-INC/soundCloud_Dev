  ...
  try {
    ...
    if ($select_stmt->rowCount() > 0) {
      ...
      if ($stmt->execute([$_SESSION["user_name"]])) {
        ...
        $insert_stmt->execute([$audio_id, $authorNameNew, $_SESSION["user_name"], ($_POST["additional-pay-ammount"] * ($admin_details["add_share_admin"] / 100)), ($_POST["additional-pay-ammount"] * ($admin_details["add_share_creator"] / 100)), '0', $date]);
        //insert payment details
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-8 p-0">
          <form class="form py-5 px-md-4 px-2 px-lg-4 bg-opacity-75" name="signupform" method="post" style="min-height: 33rem;">
            <h1 class="text-center">Optional Payment</h1>
