  ...
  try {
    ...
    if ($select_stmt->rowCount() > 0) {
      ...
      if ($stmt->execute([$_SESSION["user_name"]])) {
        ...
        $insert_stmt->execute([$audio_id, $authorNameNew, $_SESSION["user_name"], '0', '0', $_POST["charity-pay-ammount"], $date]);
        //insert payment details
      ...
      <div class="row pt-5">
        ...
        <div class="col-md-8 p-0">
          <form class="form py-5 px-md-4 px-2 px-lg-4 bg-opacity-75" name="signupform" method="post" style="min-height: 33rem;">
            <h1 class="text-center">Optional Charity</h1>
...
<script>
  // let additional_payment_element = document.getElementById('additional-pay-ammount').value;

  let charity_acc = '<?= $payDetails["charity_acc"] ?>';

  console.log(charity_acc);
  
  let auth_acc = 0;

  let additional_payment = 0;
